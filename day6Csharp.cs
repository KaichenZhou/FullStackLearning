...
Using static keyword when you want the member of a class to belong to the type rather than to the instance of the type.

const defines a constant variable whose value will not change during the lifetime of the program. 
Ex, const int num1 = '10';

readonly means that the variable or object can be assigned a value at the class scope or in a constructor only. 
...
5. What is a tuple?
Tuple means “a data structure which consists of the multiple parts”.
...
Overriding means the Methods in base class and its subclasses share the same method name and same input parameters.
...
F  //It should be override keyword
...
namespace day6Csharp
{
    class day6Csharp
    {
        ...
        static void PrintNumbers(int[] revArray)
        {
...
public abstract class Person
{
    ...
    public virtual double Salary(int s )
    {
        return s 
    }
...
{
    public override double Salary(int s)
    {
        return s;
}
